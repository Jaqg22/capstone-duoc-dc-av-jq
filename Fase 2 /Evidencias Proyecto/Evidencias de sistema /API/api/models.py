...
class Planilla(models.Model):
    ...
    Contiene la imagen subida y los datos extraídos de los recuadros de colores.
    """
    ...
    # Campos extraídos de los recuadros de colores
    # Información básica
    codigo_origen = models.CharField(max_length=10, null=True, blank=True)
    codigo_retorno = models.CharField(max_length=10, null=True, blank=True)
    numero_bus = models.CharField(max_length=10, null=True, blank=True)
    horario_origen = models.CharField(max_length=10, null=True, blank=True)
    horario_retorno = models.CharField(max_length=10, null=True, blank=True)
    numero_planilla = models.CharField(max_length=10, null=True, blank=True)
    fecha = models.CharField(max_length=20, null=True, blank=True)
    codigo_conductor = models.CharField(max_length=10, null=True, blank=True)
    codigo_asistente = models.CharField(max_length=10, null=True, blank=True)

    # Tarifas
    tarifa_1 = models.IntegerField(null=True, blank=True)
    tarifa_2 = models.IntegerField(null=True, blank=True)
    tarifa_3 = models.IntegerField(null=True, blank=True)
    tarifa_4 = models.IntegerField(null=True, blank=True)
    tarifa_5 = models.IntegerField(null=True, blank=True)
    tarifa_6 = models.IntegerField(null=True, blank=True)

    # Boletos iniciales
    b_inicial_1 = models.CharField(max_length=10, null=True, blank=True)
    b_inicial_2 = models.CharField(max_length=10, null=True, blank=True)
    b_inicial_3 = models.CharField(max_length=10, null=True, blank=True)
    b_inicial_4 = models.CharField(max_length=10, null=True, blank=True)
    b_inicial_5 = models.CharField(max_length=10, null=True, blank=True)
    b_inicial_6 = models.CharField(max_length=10, null=True, blank=True)

    # Boletos finales
    b_final_1 = models.CharField(max_length=10, null=True, blank=True)
    b_final_2 = models.CharField(max_length=10, null=True, blank=True)
    b_final_3 = models.CharField(max_length=10, null=True, blank=True)
    b_final_4 = models.CharField(max_length=10, null=True, blank=True)
    b_final_5 = models.CharField(max_length=10, null=True, blank=True)
    b_final_6 = models.CharField(max_length=10, null=True, blank=True)

    # Totales
    total_ingreso_ruta = models.IntegerField(null=True, blank=True)
    total_ingreso_oficina = models.IntegerField(null=True, blank=True)
    total_ingresos = models.IntegerField(null=True, blank=True)
    
    # Egresos
    losa = models.IntegerField(null=True, blank=True)
    pension = models.IntegerField(null=True, blank=True)
    cena = models.IntegerField(null=True, blank=True)
    viaticos = models.IntegerField(null=True, blank=True)
