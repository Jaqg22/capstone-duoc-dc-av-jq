        ...
        if serializer.is_valid():
            ...
            if not azure_service.is_configured():
                ...
                return Response(
                    {
                        'id': planilla.id,
                        'message': 'Planilla creada. Azure Form Recognizer no está configurado, procesamiento diferido.',
            ...
            try:
                ...
                # Actualizar los campos de la planilla con los datos extraídos
                for field in ['codigo_origen', 'codigo_retorno', 'numero_bus',
