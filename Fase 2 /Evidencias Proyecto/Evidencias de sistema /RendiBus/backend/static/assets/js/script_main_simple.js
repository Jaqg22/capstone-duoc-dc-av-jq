...
function openModule(module) {
    ...
    switch(module) {
        case 'planilla-digital':
            ...
            // Cargar el script completo si no existe
            if (!window.openImageScannerModal) {
                loadImageScannerModule();
            } else {
...
// Función para cargar dinámicamente el módulo de scanner de imágenes
function loadImageScannerModule() {
    showMessage('📦 Cargando módulo de scanner...', 'info');
    
    // Redirigir al script completo que tiene toda la funcionalidad
    setTimeout(() => {
