...
function openNativeMobileCamera() {
    ...
    input.onchange = function(event) {
        ...
        if (files && files.length > 0) {
            ...
            // Comprimir y subir directamente al servidor
            console.log('💾 Comprimiendo y subiendo imagen...');
            ...
            compressImage(file, 2, 1920).then(async compressedFile => {
                ...
                try {
                    ...
                    if (result.success && result.planilla_id) {
                        ...
                        localStorage.setItem('imagenNombre', compressedFile.name);
...
async function capturePhoto() {
    ...
    try {
        ...
        console.log('🚨 Subiendo imagen directamente al servidor...');
        showMessage('📤 Subiendo imagen...', 'info');
    ...
    input.onchange = async function(event) {
        ...
        if (file) {
            ...
            try {
                ...
                // Subir al servidor directamente
                const formData = new FormData();
                formData.append('imagen', compressedFile);
